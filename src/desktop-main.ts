        ...
        themes: {
            light: {
                ...
                colors: {
                    ...
                    'surface': '#fff',
                    'on-surface': '#162033',
                    'notification-background': '#e5ebf5',
                    'on-notification-background': '#1f2d43',
                    'grey': '#8c8c8c',
                    'grey-50': '#fafafa',
                    'grey-100': '#f6f8fb',
                    'grey-200': '#eeeeee',
                    ...
                    'grey-800': '#424242',
                    'grey-900': '#212121',
                    'perfect-scrollbar-thumb': '#d1d9e5',
                    'skin-bordered-background': '#fff',
                    'skin-bordered-surface': '#fff',
                    'expansion-panel-text-custom-bg': '#f6f8fb'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#1f2d43',
                    ...
                    'border-color': '#1c2a3c',
                    'border-opacity': 0.12,
                    'table-header-color': '#f6f8fb',
                    'high-emphasis-opacity': 0.9,
                    'medium-emphasis-opacity': 0.7,

                    // 👉 shadows
                    'shadow-key-umbra-color': '#1c2a3c',
            ...
            dark: {
                ...
                colors: {
                    ...
                    'teal': '#009688',
                    'background': '#111826',
                    'on-background': '#e1e7f2',
                    'surface': '#182030',
                    'on-surface': '#e1e7f2',
                    'notification-background': '#1a2435',
                    'on-notification-background': '#e1e7f2',
                    'grey': '#4d4c4b',
                    'grey-50': '#0b1620',
                    'grey-100': '#121c28',
                    'grey-200': '#1a2533',
                    ...
                    'grey-800': '#cbd8e8',
                    'grey-900': '#e6ecf6',
                    'perfect-scrollbar-thumb': '#233146',
                    'skin-bordered-background': '#121b2b',
                    'skin-bordered-surface': '#121b2b',
                    'expansion-panel-text-custom-bg': '#1a2435'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#0f1724',
                    'tooltip-background': '#1f2a3b',
                    'tooltip-color': '#e1e7f2',
                    ...
                    'border-color': '#c7d1e0',
                    'border-opacity': 0.12,
                    'table-header-color': '#141c2b',
                    'high-emphasis-opacity': 0.9,
                    'medium-emphasis-opacity': 0.7,

                    // 👉 Shadows
                    'shadow-key-umbra-color': '#0f1724',
